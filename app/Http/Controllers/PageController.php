...
class PageController extends Controller
{
    ...
    {
        $featuredPosts = [
            ['id' => 1, 'title' => 'Geladeira XYZ', 'content' => 'Descrição da geladeira.'],
            ['id' => 2, 'title' => 'Bem-vindo ao Nosso Website', 'content' => 'Explorando as melhores soluções para você.'],
            ['id' => 3, 'title' => 'Novidades', 'content' => 'Fique por dentro das últimas novidades e atualizações do setor.'],
            ['id' => 4, 'title' => 'Destaques', 'content' => 'Veja os projetos que estamos trabalhando atualmente.'],
        ];
